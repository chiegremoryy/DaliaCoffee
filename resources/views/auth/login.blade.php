...
<body
    class="min-h-screen bg-gradient-to-br from-[#8d6e63] via-[#a1887f] to-[#bcaaa4] flex items-center justify-center p-4 coffee-pattern">
    ...
    <div class="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-0 rounded-3xl overflow-hidden shadow-2xl">
        ...
        <div class="glass-effect p-8 sm:p-12 lg:p-16 order-2 lg:order-1">
            ...
            <div class="text-center mb-8">
                <img src="{{ asset('images/dalia-coffee.png') }}" alt="Dalia Coffee Logo"
                    class="max-w-[180px] mx-auto mb-4">
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-6">
                ...
                <div class="relative">
                    <label for="email"
                        class="block text-[#4e342e] font-medium mb-2 text-sm uppercase tracking-wide">Email
                        Address</label>
                    <div class="relative">
                        <input type="email" name="email" id="email"
                            ...
                            required placeholder="barista@coffee.com">
                        <svg class="w-5 h-5 absolute left-4 top-1/2 transform -translate-y-1/2 text-[#8d6e63]"
                ...
                <div class="relative">
                    <label for="password"
                        class="block text-[#4e342e] font-medium mb-2 text-sm uppercase tracking-wide">Password</label>
                    <div class="relative">
            ...
            <div class="mt-8 text-center">
                <p class="text-[#6d4c41] text-sm">Don't have an account?
                    <a href="#"
                        class="text-[#5d4037] font-semibold hover:text-[#4e342e] underline decoration-2 underline-offset-2">Create
                        Account</a>
                </p>
            </div>
        </div>
        ...
        <div
            class="bg-gradient-to-br from-[#4e342e] to-[#3e2723] text-white p-8 sm:p-12 lg:p-16 flex flex-col justify-center items-center relative overflow-hidden order-1 lg:order-2">
            <!-- Decorative circles -->
            ...
            <div class="relative z-10 text-center">
                <img src="{{ asset('images/ilustrasi-kopi.png') }}" alt="Coffee Illustration"
