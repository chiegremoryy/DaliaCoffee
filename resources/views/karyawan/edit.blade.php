...
<div class="max-w-xl mx-auto bg-white rounded-2xl border border-slate-100 shadow-[0_2px_20px_-4px_rgba(0,0,0,0.04)] p-6 sm:p-8">
    ...
    <div class="mb-8">
        <div class="flex items-center gap-2 mb-2">
            ...
            <h2 class="text-2xl font-semibold text-dark font-poppins">Edit Karyawan</h2>
        </div>
        <p class="text-sm text-slate-400">
            Perbarui data akun kasir kedai
        </p>
    </div>
    ...
    <!-- Form -->
    <form action="{{ route('karyawan.update', $user->id) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
