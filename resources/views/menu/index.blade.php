                                ...
                                <tr class="group hover:bg-slate-50/80 transition-colors border-b border-slate-50 last:border-0">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            @if($menu->image)
                                                <img src="{{ asset('storage/' . $menu->image) }}" class="w-10 h-10 object-cover rounded-xl"
                                                    alt="{{ $menu->name }}">
                                            @else
                                                <div
                        ...
                        : 'bg-slate-100 text-slate-600 border border-slate-200' }}">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex justify-center gap-3">
                                            ...
                                            <form action="{{ route('menu.destroy', $menu->id) }}" method="POST" class="form-delete">
                                                @csrf
                                                @method('DELETE')
        ...
        <div class="sm:hidden space-y-4">
            @forelse ($menus as $menu)
                <div class="bg-white rounded-xl border border-slate-100 p-4 shadow-sm">
                    <div class="flex items-center gap-3">
                        @if($menu->image)
                            <img src="{{ asset('storage/' . $menu->image) }}" class="w-12 h-12 object-cover rounded-xl"
                                alt="{{ $menu->name }}">
                        @else
